...
function ProjectIdeas(){
    ...
    <div className="mx-[200px]">
        ...
        <ul className="mx-[40px] my-[35px]">
            <li className="my-[15px]" content="&bull;">
                <p className="text-gray-600 prompt mx-[30px]">Now-a-days I have some interest in cricket.<br></br> I am thinking of a data-visualisation project where I display vital information
