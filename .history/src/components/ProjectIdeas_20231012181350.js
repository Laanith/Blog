...
function ProjectIdeas(){
    ...
    <div className="mx-[200px]">
        ...
        <ul>
            <li>
                <p className="text-gray-600 prompt mx-[5px]">Now-a-days I have some interest in cricket. I am thinking of a data-visualisation project where I display vital information
