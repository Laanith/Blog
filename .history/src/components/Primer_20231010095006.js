    ...
    return (
        <><div className="mx-[200px] my-[45px]">
            <p className="text-gray-600 mx-10 prompt">
                ...
                <br></br>
                <br></br>
                I am still building this blog. It is also a way to improvise my web-dev skills. As of now I am using React to host this. I don't know
                what I will shift to later on.
