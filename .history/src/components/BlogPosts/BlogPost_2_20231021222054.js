    ...
    <>
      ...
      <div id="wrapper" className="mx-[200px] mb-[80px]">
        ...
        <p className="text-gray-600 prompt">
          ...
          Regression in DL paradigm.
          That's how the whole process went on.
          Training part is actually good, waiting for model to train epoch by epoch while it runs on GPU associated with Kaggle.
        </p>
      </div>
      <Footer></Footer>
    </>
