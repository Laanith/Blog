    ...
    <>
      ...
      <div id="wrapper" className="mx-[200px]">
        <p className="text-gray-600 prompt mb-[30px]">
          ...
          <br></br>
                  <br></br>
                  Thanks for reading. I may stop blogging for a month as the next month schedule is actually packed up as my end semesters are gonna hunt me by the end of November.
        </p>
