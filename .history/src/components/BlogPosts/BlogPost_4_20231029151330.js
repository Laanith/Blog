      ...
      <div id="wrapper" className="mx-[200px]">
        <p className="text-gray-600 prompt">
          ...
          relatively easy task actually, which took 4 days of my free time apart
                  ...
                  2. Next comes  the web dev deployment part. It is actually a creepy thing that took most of my time. The major inconvenience I faced is that tensorflowjs does not load '.h5' keras models directly into javascript. When I looked into the documentation I found that you have to use <strong></strong>tensorflow_converter'
        </p>
      </div>
      <Footer></Footer>
    </>
