    ...
    <>
      ...
      <div id="wrapper" className="mx-[200px]">
        ...
        <p className="text-gray-600 prompt">
          ...
          Hi all. ( Incase there are multiple people reading this except me and you.)
          <br></br>
                  <br></br>
                  I got a free weekend on which I actually wasted ( not literally wasted but actually learnt something) 3hrs spending time working on 
        </p>
      </div>
      <Footer></Footer>
    </>
