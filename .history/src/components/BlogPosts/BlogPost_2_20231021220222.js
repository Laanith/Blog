    ...
    <>
      ...
      <div id="wrapper" className="mx-[200px] mb-[80px]">
        ...
        <p className="text-gray-600 prompt">
          ...
          anyways. I actually appreciate your curiosity, otherwise you wouldn't be here reading a blog of some random anonymous mad man writing anything that he wants on the internet.
        </p>
      </div>
      <Footer></Footer>
    </>
