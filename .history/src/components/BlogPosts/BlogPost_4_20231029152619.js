    ...
    <>
      ...
      <div id="wrapper" className="mx-[200px]">
        <p className="text-gray-600 prompt mb-[30px]">
          ...
          <br></br>
                  <br></br>
                  I am including a screenshot of the project working. Pardon about the UI, it is still raw. I will modify it lateron. I just have to play with a few lines of css that's all.
        </p>
      </div>
      <Footer></Footer>
    </>
