    ...
    <>
      ...
      <div id="wrapper" className="mx-[200px]">
        <p className="text-gray-600 prompt mb-[30px]">
          ...
          <br></br>
                  <br></br>
                  5. Then the final part included prediction of the output digit using model that is loaded through tensorflowjs functions. This thing involved javascript promises that are actually my nightmares as they ususally involve making separate asynchronous functions as wrappers. This thing really involved a lot of 'async' and 'await' keywords of JS. Finally the predicted output is sent through the response object (which is a built in object like 'File' object in javascript.). The frontend then displays the predicted class.
        </p>
      </div>
      <Footer></Footer>
    </>
