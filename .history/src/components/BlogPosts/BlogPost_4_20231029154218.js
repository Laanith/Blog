    ...
    <>
      ...
      <div id="wrapper" className="mx-[200px]">
        <p className="text-gray-600 prompt mb-[30px]">
          ...
          <br></br>
                  <br></br>
                  Thanks for reading. I may stop blogging for a month as the next month schedule is actually packed up as my end semesters are gonna hunt me by the end of November. I am actually a mediocre in terms of my academic achievements and I have to figure out some way to out do my past self. Hope I will write those exams well. Let's meet after a month. Or probably even before it. Who knows, life is undeterministic. Bye.
        </p>
