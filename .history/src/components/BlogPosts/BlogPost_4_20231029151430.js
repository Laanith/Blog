    ...
    <>
      ...
      <div id="wrapper" className="mx-[200px]">
        <p className="text-gray-600 prompt">
          ...
          <br></br>
                  <br></br>
                  I am writing this to discuss the workflow of how I deployed
          ...
          and saved it as '.h5' file (keras models are intended to have this
                  ...
                  2. Next comes the web dev deployment part. It is actually
          ...
          that is installed into system using <i>pip install tensorflowjs</i>
        </p>
      </div>
      <Footer></Footer>
    </>
