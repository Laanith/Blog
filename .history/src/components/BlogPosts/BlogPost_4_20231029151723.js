    ...
    <>
      ...
      <div id="wrapper" className="mx-[200px]">
        <p className="text-gray-600 prompt">
          ...
          <br></br>
          <br></br>
          3. The further process is relatively small. The frontend involved a form that took an image file through which the file transfers along with binary data using Javascript 'File' object.
        </p>
      </div>
      <Footer></Footer>
    </>
