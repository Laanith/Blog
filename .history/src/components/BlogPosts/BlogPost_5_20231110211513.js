    ...
    <>
      ...
      <div id="wrapper" className="mx-[200px]">
        ...
        <p className="text-gray-600 prompt">
          ...
          <br></br>
                  <br></br>
                  However, this was the scene 1.5 years ago. I didn't like its CSS then. I always thought of modifying it, which actually took 3 hrs but needed a motivation that  continued for one and a half year in order to start doing the thing. The UI still looks minimal, cuz I am not  pro in CSS>
        </p>
      </div>
      <Footer></Footer>
    </>
