    ...
    <>
      ...
      <div id="wrapper" className="mx-[200px] mb-[80px]">
        ...
        <p className="text-gray-600 prompt">
          ...
          follows. The expected input and output of model was this : RGB 1280 x
          720 image &rarr; [[x1,y1],[x2,y2],[x3,y3],[x4,y4]]
          <br></br>
          The model pipeline goes as follows :
          <br></br>
          RGB 1280 x 720 image &rarr; Binary Mask of Screen
