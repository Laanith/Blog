    ...
    <>
      ...
      <div id="wrapper" className="mx-[200px]">
        ...
        <p className="text-gray-600 prompt">
          ...
          <br></br>
          <br></br>
                  Well here we go. The project actually uses XAMPP stack. It is just a stupid little project that is all about 
                  generating number board and tickets for thambola game. 


                  I got to know about PHP shell_exec function actually through it, a function in PHP through which you run shell commands on server through PHP and collect the following output as string.
        </p>
      </div>
      <Footer></Footer>
    </>
