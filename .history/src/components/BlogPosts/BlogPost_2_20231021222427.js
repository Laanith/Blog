    ...
    <>
      ...
      <div id="wrapper" className="mx-[200px] mb-[80px]">
        ...
        <p className="text-gray-600 prompt">
          ...
          The accuracy was about 0.97 on Kaggle. ( There is no accuracy associated with Regression models but actually, tensorflow uses it as a measure to tell us the robustness of the modell )
        </p>
      </div>
      <Footer></Footer>
    </>
