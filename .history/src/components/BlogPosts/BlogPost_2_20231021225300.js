    ...
    <>
      ...
      <div id="wrapper" className="mx-[200px] mb-[80px]">
        ...
        <p className="text-gray-600 prompt">
          ...
          Actually this blog was to appreciate the excellence of deep learning models in the field of computer vision. I love this a lot. Hope I will do more projects upon this.
        </p>
      </div>
      <Footer></Footer>
    </>
