...
import resizedImg from "../../images/image.png";
import resizedMaskImg from "../../images/imagemask.png";
...
const imgMaskProps = {
  imgSrc: resizedMaskImg,
  type: "contain",
  imgAlt: "Predicted Mask Image",
  scale: 0.8,
  marginTop: 0,
  marginBottom: -0,
};
    ...
    <>
      ...
      <div id="wrapper" className="mx-[200px] mb-[80px]">
        ...
        <p className="text-gray-600 prompt">
          ...
          <br></br>
          <DoubleImageComponent props={DoubleImageProps}></DoubleImageComponent>
          <br></br>
          ...
          <br></br>
          <br></br>
          That's it, folks. That's how the whole process went on. I conclude this blog with this. 
          Actually this blog was to appreciate the excellence of deep learning models in the field of computer vision. I love this a lot. Hope I will do more projects in this domain.
        </p>
      </div>
      <Footer></Footer>
    </>
