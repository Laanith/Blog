    ...
    <>
      ...
      <div id="wrapper" className="mx-[200px] mb-[80px]">
        ...
        <p className="text-gray-600 prompt">
          ...
          with some random pics and it worked out pretty well. )
          <br></br>
          <br></br>
          ...
          <a className="text-blue-600" href="https://www.geeksforgeeks.org/u-net-architecture-explained/">
            link
          </a>{" "}
          anyways. I actually appreciate your curiosity, otherwise you wouldn't be here reading a blog of some random anonymous mad man writing anything that he wants on the internet.Getting back to the point, 
        </p>
      </div>
      <Footer></Footer>
    </>
