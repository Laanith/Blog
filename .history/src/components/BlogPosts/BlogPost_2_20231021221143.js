    ...
    <>
      ...
      <div id="wrapper" className="mx-[200px] mb-[80px]">
        ...
        <p className="text-gray-600 prompt">
          ...
          So I took all my training images, used that U-Net model to give me predictions of the masks to make a new training dataset of masks. Now I used corrseponding point pairs as labels. I implemented a CNN in which the input was this image, used to tf.keras.Conv2D() layers upon this image each followed by a MaxPooling layer
        </p>
      </div>
      <Footer></Footer>
    </>
