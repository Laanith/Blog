    ...
    <>
      ...
      <div id="wrapper" className="mx-[200px] mb-[80px]">
        ...
        <p className="text-gray-600 prompt">
          ...
          <br></br>
          <br></br>
          That's how the whole pipeline went off. The model gave me pretty good results. There was atmost 5-6 pixel 
          variation in the final predictions for both train and test images. Actually the training and test set were a lot refined.
          They did not have any abrupt intensity and color variations and thus making model to stand robust.
          The accuracy was about 0.97 on Kaggle. ( There is no accuracy associated with Regression models but actually, tensorflow uses it as a measure to tell us the robustness of the model ). 


          Well, upon submission the model actually gave me a Kaggle score of 0.96 which is pretty high. 
          That was enough for me, thanks to my 2 days of sleeplessness by then. I quit improving that later on
        </p>
      </div>
      <Footer></Footer>
    </>
