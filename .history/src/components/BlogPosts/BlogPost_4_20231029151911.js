    ...
    <>
      ...
      <div id="wrapper" className="mx-[200px]">
        <p className="text-gray-600 prompt">
          ...
          <br></br>
                  <br></br>
                  4. Later step on server side includes analysing the response object, extracting the received File object from client using <i>Multer</i> package in node.js. Next part involved resizing this recieved image as per model's input specifications, namely 28 x 28 grayscale image.        </p>
      </div>
      <Footer></Footer>
    </>
  );
