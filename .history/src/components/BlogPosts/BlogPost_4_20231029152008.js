    ...
    <>
      ...
      <div id="wrapper" className="mx-[200px]">
        <p className="text-gray-600 prompt">
          ...
          package in node.js. Next part involved reading this image (using Jimp package - shorthand for Javascript image processing)  and resizing this recieved image as
                  per model's input specifications, namely 28 x 28 grayscale image.{" "}
