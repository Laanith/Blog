    ...
    <>
      ...
      <div id="wrapper" className="mx-[200px] mb-[80px]">
        ...
        <p className="text-gray-600 prompt">
          ...
          So I took all my training images, used that U-Net model to give me predictions of the masks to make a new training dataset of masks. Now I used corrseponding point pairs as labels. I implemented a CNN in which the input was this image, used to tf.keras.layers.Conv2D() [ sorry for using python function directly &#58; &rt; ]  layers upon this image each followed by a MaxPooling layer. Then I flattened the output to train into dense (fully-connected) layers that gave an output of a
          8x1 vector, where each element in the vector is a representation of a co-ordinate in point pairs.

          I trained this custom CNN using Mean-Square Error as loss function, and I later on got to know that this is called as 
          Corner Regression in DL paradigm.
        </p>
      </div>
      <Footer></Footer>
    </>
