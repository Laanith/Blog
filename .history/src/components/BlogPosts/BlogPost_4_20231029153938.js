    ...
    <>
      ...
      <div id="wrapper" className="mx-[200px]">
        <p className="text-gray-600 prompt mb-[30px]">
          ...
          ususally involve making separate asynchronous functions as wrappers (-_-).
          This thing really involved a lot of 'async' and 'await' keywords of
          JS. Finally the predicted output is sent through the response object
          (which is a built in object like 'File' object in javascript.). The
          frontend then displays the predicted class.
          <br></br>
          ...
          <br></br>
                  <br></br>
                  The fact that I can use this as a template to deploy further complicated models actually makes me feel good.
                  Finally , I have a good satifaction of doing somethin' that actually helped me upskill myself after 4 days of reckless gruelling.
              </p>
