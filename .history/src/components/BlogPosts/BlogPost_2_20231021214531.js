    ...
    <>
      ...
      <div id="wrapper" className="mx-[200px] mb-[80px]">
        ...
        <p className="text-gray-600 prompt">
          ...
          <sub>4</sub>,y<sub>4</sub>] ] format. Where [x1,y1] are the pixel
        ...
        <p className="text-gray-600 prompt">
          ...
          <br></br>
          <br></br>
          RGB 1280 x 720 image &rarr; Binary Mask of Screen &rarr; [ [x
          ...
          for implementing deep-learning models in python) and then
        </p>
      </div>
      <Footer></Footer>
    </>
