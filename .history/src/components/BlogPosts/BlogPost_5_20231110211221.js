    ...
    <>
      ...
      <div id="wrapper" className="mx-[200px]">
        ...
        <p className="text-gray-600 prompt">
          ...
          <br></br>
                  <br></br>
                  Numberboard for housie game is actually built by generating random numbers from 1 to 90 and storing the already generated numbers to make sure that they will not get duplicated again. Accounts that were created are diverted to MySQL database that comes along with XAMPP server.
        </p>
      </div>
      <Footer></Footer>
    </>
