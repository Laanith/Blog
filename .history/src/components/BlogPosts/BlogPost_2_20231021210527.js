    ...
    <>
      ...
      <div id="wrapper" className="mx-[200px] mb-[80px]">
        ...
        <p className="text-gray-600 prompt">
          ...
          blog on 16th October morning. Then I just woke up and wrote the stuff
          ...
          follows. The expected input and output of model was this :<br></br>
          <br></br>
          <br></br>
          RGB 1280 x 720 image <strong>&rarr;
&rarr;
&rarr;</strong> [[x1,y1],[x2,y2],[x3,y3],[x4,y4]]
          <br></br>
          <br></br>
          The model pipeline goes as follows :<br></br>
          RGB 1280 x 720 image <strong> Binary Mask of Screen <strong>
