function BlogPost(){
    ...
    <div className="flex h-[300px] text-black shadow-2xl shadow-slate-300 justify-between py-auto px-auto BlogPost">
                <img className="w-[150px] h-[150px]" alt="teri maa ki .." src="https://miro.medium.com/v2/resize:fit:828/format:webp/1*NZikwvxFY6gVsjY64itdiw.jpeg"></img>
                <div>
